...
### Fixed
- Restored missing translations across the 57 locales for Options section headings, Focus Session sound settings, and several existing interface messages.
- Added a regression check so locale files cannot silently omit messages defined by the default English locale.
...
### Changed
- The blocked page now quietly explains whether an always-active rule, current schedule, reached daily limit, or Focus Session caused the block.

## [5.2.11] - 2026-09-09

### Fixed
- Updated Firefox license checks to use the current privacy-minimized server response while preserving compatibility with older releases.

## [5.2.10] - 2026-09-08

### Fixed
- Improved feedback when an entered Pro license key is not accepted.

## [5.2.9] - 2026-09-08

### Fixed
- Improved rule reliability after browser restarts on older Firefox versions.

## [5.2.8] - 2026-09-07

### Changed
- Simplified internal Pro license state handling without changing activation or access behavior.

## [5.2.7] - 2026-09-07

### Privacy
- Updated Firefox privacy declarations and consent handling for Pro license verification.
- Simplified the Firefox uninstall feedback flow.

### Added
- Added regression coverage for license verification consent and Firefox compatibility.
